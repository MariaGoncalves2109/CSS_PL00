# Projecto de Referência de para Setup das ferramentas

## O que fazer

Este projecto serve para verificar que todas as dependências necessárias aos projectos estão a funcionar.

## Dependências

Este projecto vai usar [Java17+](https://www.oracle.com/java/technologies/downloads/) e [PostgreSQL](https://www.postgresql.org/). Não precisam instalar o PostgreSQL pois ele será executado dentro do container mas é necessário que tenham o Java instalado.

### Windows

Instalar [Docker Desktop](https://docs.docker.com/desktop/install/windows-install/), [Python 3](https://www.python.org/ftp/python/3.11.2/python-3.11.2-amd64.exe) e [DBeaver](https://dbeaver.io/download/)
...
Seguir o guião indicado para o [DBeaver](https://dbeaver.io/download/)
...
* Uma instância de um container com PostgreSQL

## Terceiro passo - testar o servidor

Abrir http://localhost:8081 num browser e verificar que aparece a string "Olá Mundo".

Pode ainda confirmar que consegue ver um objecto JSON em http://localhost:8081/api/author/1
...
Abra http://localhost:8081/swagger-ui/index.html num browser para visualizar a documentação interativa da API. Use os endpoints para:
...
## Sexto passo - inspecionar a BD com o DBeaver

* Abra o DBeaver
* Crie uma nova conexão
* Escolha o PostgreSQL como base de dados
* Mude o `Connect By` de *Host* para *URL* e insira:
    * `jdbc:postgresql://localhost:54320/testdb`
* Insita a palavra passe como **admin** e carregue no botão *finish*
* Navegue pela estrutura: Databases → testdb → Schemas → public → Tables
    * Se tudo correr bem, deve conseguir ver duas tabelas: `author` e `book`
## Atividade Extra
...
## O `run.sh` não está a correr no meu macos com Apple Silicon (M1, M2, ...).
